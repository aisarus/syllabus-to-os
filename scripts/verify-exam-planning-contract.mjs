...
const examEngine = await readFile("src/components/exam-engine.tsx", "utf8");
...
assert(examEngine.includes("ExamPlanningPanel"));
...
assert(docs.includes("does not predict a grade, pass probability or readiness"));
